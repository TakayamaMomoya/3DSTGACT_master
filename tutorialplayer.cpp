...
// ブースト管理
//=====================================================
void CTutorialPlayer::ManageBoost(float fBoostOld)
{
...
// オフセットの管理
//=====================================================
void CTutorialPlayer::ManageOffset(void)
{
	// 汎用処理の取得
...
// 当たり判定管理
//=====================================================
void CTutorialPlayer::ManageCollision(void)
{
	bool bLandMesh;
...
// メッシュフィールドとの判定
//=====================================================
bool CTutorialPlayer::CollisionField(void)
{
...
// 操作処理
//=====================================================
void CTutorialPlayer::Input(void)
{
	// 入力情報入手
...
// 射撃操作
//=====================================================
void CTutorialPlayer::InputShot(void)
{
	CInputKeyboard *pKeyboard = CManager::GetKeyboard();
	CInputMouse *pMouse = CManager::GetMouse();
	CInputJoypad *pJoypad = CManager::GetJoypad();
...
// カメラ操作
//=====================================================
void CTutorialPlayer::InputCamera(void)
{
	// 汎用処理の取得
	CUniversal *pUniversal = CManager::GetUniversal();
...
// ロックオン処理
//=====================================================
void CTutorialPlayer::Lockon(void)
{
	// 汎用処理の取得
	CUniversal *pUniversal = CManager::GetUniversal();
...
// マトリックスの設定
//=====================================================
void CTutorialPlayer::SetMatrix(void)
{
	// カメラ取得
	CCamera::Camera *pCamera = CManager::GetCamera()->GetCamera();
...
// 状態管理
//=====================================================
void CTutorialPlayer::ManageState(void)
{
	switch (m_state)
	{
	case CTutorialPlayer::STATE_NORMAL:
		break;
	case CTutorialPlayer::STATE_DEATH:
...
// モーション管理
//=====================================================
void CTutorialPlayer::ManageMotion(void)
{
	// 変数宣言
...
// 目標方向を向く処理
//=====================================================
void CTutorialPlayer::Turn(D3DXVECTOR3 move, float fRotOld)
{
	// 汎用処理の取得
	CUniversal *pUniversal = CManager::GetUniversal();
...
// 上半身の回転制御
//=====================================================
void CTutorialPlayer::LimitUpperRot(float fRotOld)
{
	// 汎用処理の取得
	CUniversal *pUniversal = CManager::GetUniversal();
...
// 偏差撃ちの処理
//=====================================================
D3DXVECTOR3 CTutorialPlayer::LinePridiction(D3DXVECTOR3 pos, float fSpeedBullet, D3DXVECTOR3 posTarget, D3DXVECTOR3 moveTarget)
{
	// 変数宣言
	D3DXVECTOR3 vecDiff;
	float fSpeedTarget;
...
// プラスの最小値を返す処理
//=====================================================
float CTutorialPlayer::PlusMin(float fData1, float fData2)
{
...
// ブーストパーティクルの設定
//=====================================================
void CTutorialPlayer::Boost(void)
{
	// 汎用処理の取得
	CUniversal *pUniversal = CManager::GetUniversal();
...
// ヒット処理
//=====================================================
void CTutorialPlayer::Hit(float fDamage)
{
	if (m_state == STATE_DEATH)
	{
		return;
...
// ヒット数設定
//=====================================================
void CTutorialPlayer::SetNumHit(int nNumHit)
{
	if (m_pAssess != nullptr)
	{// ヒット評価の加減算
...
// 生成処理
//=====================================================
CTutorialPlayer *CTutorialPlayer::Create(void)
{
...
// パラメーター読込処理
//=====================================================
HRESULT CTutorialPlayer::Load(void)
{
	// 変数宣言
	char cTemp[256];
